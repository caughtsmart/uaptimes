---
title: "The FAA Finally Has a UAP Reporting Rule. The Same Order Deletes the Radar 45 Days Later"
seoTitle: "FAA Radar Data on UAP Is Erased After 45 Days"
description: "A 26-year air traffic controller has gone on the record about what civil radar does with unidentified targets: filters them out, then wipes the raw data after 45 days. Both rules live in the same FAA order."
pubDate: 2026-08-06
...
credibility: 2
source: "Safe Aerospace Podcast, episode 1 — 'Inside the Radar Room', 10 July 2026; FAA Order JO 7210.3EE; FAA Notice N 7210.970; NASA UAP Independent Study Team final report"
sourceUrl: "https://www.youtube.com/watch?v=NvRzqkcitDw"
featured: false
draft: false
---
...
That cuts both ways. The sceptic who says "if these things were real, radar would show them" is misunderstanding how radar is configured. The believer pointing at a sudden surge in detections is looking at a settings change, not an invasion — the same trap we flagged when [airline pilot sighting numbers started climbing](/articles/commercial-pilots-sightings-surge/).
...
None of that requires believing anything is up there. It requires only accepting that a system which records unidentified objects and then deletes the recording can never answer the question. It is the same structural gap running through [the incursions over American military bases](/articles/uap-military-base-incursions-authority-gap/): not secrecy, not physics, just nobody's job.

##### The UAP Times take

Credibility 2 — and, as ever, the rating is about the claim in the headline, not about aliens.
...
*Further reading: [Stephenville 2008: The Texas Lights the Radar Backed Up](/articles/stephenville-2008/) and [The Intelligence Community Now Has a Duty to Report UFOs](/articles/odni-pursue-memo-uap-reporting-duty/).*
