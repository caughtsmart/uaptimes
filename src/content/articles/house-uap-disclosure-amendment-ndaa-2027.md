...
Note too that we are relying on anonymous officials describing a directive whose text has not been published: a materially weaker footing than the House vote. That opacity has a second cost. Within days, the disclosure movement was [publicly arguing about which of its own figureheads the process had captured](/articles/elizondo-controlled-disclosure-row/) rather than about the mechanism itself — which is what happens when the mechanism cannot be read.
