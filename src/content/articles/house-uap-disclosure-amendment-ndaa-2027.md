...
sourceUrl: "https://rules.house.gov/bill/119/hr-8800"
featured: true
draft: false
---
...
Note too that we are relying on anonymous officials describing a directive whose text has not been published: a materially weaker footing than the House vote. *Update, 2 August: ODNI has since issued [written implementing guidance with a 30-day deadline](/articles/odni-pursue-memo-uap-reporting-duty/), which sharpens the mechanism considerably — though that memo has not been published either.* That opacity has a second cost. Within days, the disclosure movement was [publicly arguing about which of its own figureheads the process had captured](/articles/elizondo-controlled-disclosure-row/) rather than about the mechanism itself — which is what happens when the mechanism cannot be read.
...
Neither man is a neutral arbiter; both have skin in a particular game. But their central point survives that objection intact, and it is the point this site keeps returning to: raw files without analysis are not knowledge. The administration's answer to that gap is a [scientific advisory council under Avi Loeb](/articles/uap-science-advisory-council-loeb/), convened in June — though it too has been handed only the material already released. A compelling narrative report from a credible aviator is a *report*. It tells you what a trained observer perceived and sincerely believed. It does not tell you what was there. That gap is the entire subject — it is why the surge in [pilot reporting](/articles/commercial-pilots-sightings-surge/) measures the reporting system at least as much as the sky, and why even the best-corroborated case on the books, the [2004 Nimitz encounter](/articles/tic-tac-encounter-explained/), gets shakier the closer you look at the specific numbers.
