---
title: "Nobody Has Ever Known How Far Away a UFO Was. Three Cameras Over Las Vegas Are Trying to Fix That"
seoTitle: "Galileo Project: Measuring UAP Distance by Triangulation"
description: "Every famous UAP video shares one flaw: no range. Avi Loeb's Galileo Project has built a triangulating observatory network to supply the missing number — and its first published results are a lesson in what honest data looks like."
pubDate: 2026-07-27
...
sourceUrl: "https://arxiv.org/abs/2411.07956"
featured: true
draft: false
---
...
This is why the debunking of UAP footage so often collapses into an argument about parallax, glare and camera artefacts rather than about the object. It is also why the most credible case in the modern canon still wobbles under scrutiny. The [2004 Nimitz "Tic Tac" encounter](/articles/tic-tac-encounter-explained/) has multiple trained witnesses and cross-sensor corroboration, yet its most-repeated performance figures — the plunge from 80,000 feet, the impossible acceleration — rest on interpretation rather than a clean instrument log. The witnesses may well be describing exactly what they saw. The numbers are still soft.

The same defect runs through the official record. [AARO's annual reporting](/articles/pentagon-uap-report-2026/) resolves cases as balloons, birds and drones where the data allow, and leaves the rest in an "insufficient data" pile that is not evidence of anything except insufficient data. And the [surge in commercial pilot reports](/articles/commercial-pilots-sightings-surge/) measures the reporting system at least as much as it measures the sky. It applies just as ruthlessly above the atmosphere: the [1996 shuttle photographs the Pentagon has now filed as unresolved](/articles/sts-80-columbia-1996-shuttle-photographs/) were released without the timing or scale data that would let anyone work out whether the object is metres or kilometres away.
