---
title: "Four Telescopes Listened to 3I/ATLAS for a Year. The Silence Is the Result"
seoTitle: "3I/ATLAS: A Year of Technosignature Searches"
description: "A year after the third interstellar object was discovered, the last of the radio searches has been published — and none of them heard anything. Even Avi Loeb has quietly marked his own scale down."
pubDate: 2026-07-28
...
sourceUrl: "https://arxiv.org/abs/2607.01666"
featured: true
draft: false
---
...
It is the same logic we set out when the [Galileo Project published an upper limit rather than a discovery](/articles/galileo-project-triangulation-distance-problem/) from half a million tracked objects. A well-characterised null converts "we don't know" into "below this threshold, over this window, there was nothing." Compare that with the [pile of unresolved cases in AARO's annual reporting](/articles/pentagon-uap-report-2026/), where "unidentified" so often means nothing more than "the sensor wasn't good enough." The difference between an unexplained case and a measured non-detection is the entire distance between folklore and science.
...
This is the same failure mode we flagged in the [surge of commercial pilot reports](/articles/commercial-pilots-sightings-surge/): an anomaly is only anomalous against a properly understood base rate, and we have observed precisely three interstellar objects. A sample of three has no meaningful "normal" to deviate from.
